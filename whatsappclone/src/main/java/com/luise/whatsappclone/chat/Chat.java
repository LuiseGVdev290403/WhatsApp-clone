...
import com.luise.whatsappclone.message.Message;
import com.luise.whatsappclone.message.MessageState;
import com.luise.whatsappclone.message.MessageType;
...
public class Chat extends BaseAuditingEntity {
    ...
    public String getChatName (final String senderId ) {
        ...
        return recipient.getLastName() + " " + recipient.getLastName();
    }
